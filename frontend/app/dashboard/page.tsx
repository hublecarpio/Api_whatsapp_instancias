      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="card text-center py-12">
          <p className="text-gray-600 mb-4">
            No tienes ninguna empresa configurada todavía.
          </p>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="card">
          ...
          <div className={`text-lg font-bold ${hasWhatsApp ? 'text-green-600' : 'text-yellow-600'}`}>
            {hasWhatsApp ? 'Conectado' : 'Desconectado'}
          </div>
        </div>
        <div className="card">
          <div className="text-sm text-gray-500 mb-1">Bot IA</div>
          <div className={`text-lg font-bold ${currentBusiness?.botEnabled ? 'text-green-600' : 'text-gray-400'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Mi empresa</h2>
          <div className="space-y-3">
            ...
            {currentBusiness?.industry && (
              <div>
                ...
                <p className="font-medium">{currentBusiness.industry}</p>
              </div>
            )}
            <div>
              <span className="text-sm text-gray-500">Modelo IA:</span>
              <p className="font-medium">{currentBusiness?.openaiModel || 'No configurado'}</p>
            </div>
          </div>
        </div>
      </div>
