...
export const authApi = {
  register: (data: { name: string; businessName: string; email: string; phone?: string; password: string; referralCode?: string }) =>
...
export const businessApi = {
  ...
  resetConfig: (id: string, instanceId?: string) => 
    api.post(`/business/${id}/reset-config`, { instanceId })
};
...
export const waApi = {
  ...
  updateInstance: (instanceId: string, businessId: string, data: { name?: string; businessObjective?: 'SALES' | 'APPOINTMENTS'; botEnabled?: boolean; slug?: string | null; catalogLogoUrl?: string | null }) => 
  ...
  reset: (businessId: string) => api.post(`/wa/${businessId}/reset`),
...
export const tagsApi = {
  ...
  removeAssignment: (businessId: string, contactPhone: string, tagId: string) =>
    api.delete(`/tags/assign/${tagId}?business_id=${businessId}&contact_phone=${contactPhone}`),
